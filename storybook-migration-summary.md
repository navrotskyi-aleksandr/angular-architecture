...
- `pnpm dlx storybook@latest automigrate --config-dir libs/storybook-app-a/.storybook`

- `pnpm dlx storybook@latest automigrate --config-dir libs/storybook-app-b/.storybook`
